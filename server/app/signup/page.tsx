...
export default function SignupPage() {
  ...
  const handleOAuthSignup = (provider: 'github' | 'gitlab') => {
  ...
  const handleEmailSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      localStorage.setItem('kasoku_token', loginData.token)
      localStorage.setItem('kasoku_user_id', loginData.user.id)
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="container mx-auto px-4 py-20 max-w-md">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <h1 className="text-3xl font-bold mb-2 text-center">Get Started with Kasoku</h1>
          <p className="text-muted-foreground text-center mb-8">
            Sign up to start caching and accelerating your builds
          </p>
          ...
          {!showEmailForm ? (
            <div className="space-y-4">
              <Button onClick={() => handleOAuthSignup('github')} variant="outline" className="w-full h-12 text-base" size="lg">
              ...
              <Button onClick={() => handleOAuthSignup('gitlab')} variant="outline" className="w-full h-12 text-base" size="lg">
